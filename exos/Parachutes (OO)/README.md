...
- De vous faire revoir le principe de base d'un moteur de jeu vidéo
- De vous faire manipuler des listes d'objets (Collections)
- De mettre en oeuvre les bonnes pratiques de la POO

## Etapes

1. Créer un projet de type console, nommé "ParaClub", dans le dossier `C:\Temp`, puis:
   - Ajouter la classe statique "Config" dans votre projet, qui définit les constantes:
   ...
   - Utiliser les méthodes de la classe [Console](https://learn.microsoft.com/fr-fr/dotnet/api/system.console?view=net-7.0) pour dimensionner la fenêtre selon les constantes que l'on vient de définir.
...
9. Faire un club de parachutistes dans le programme principal avec une liste de parachutistes `List<Para>`. Modifier votre avion pour qu'il aie à son bord une liste de parachutistes (ce ne sont pas obligatoirement ceux du club!) et qu'il en éjecte un à chaque fois que l'utilisateur presse la barre d'espace.
